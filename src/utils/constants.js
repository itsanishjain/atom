...
export const TestStablecoinABI = [
  {
    inputs: [],
    stateMutability: "nonpayable",
    type: "constructor",
...
export const PoolABI = [
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "enum Pool.currency",
        name: "_currency",
        type: "uint8",
      },
      {
